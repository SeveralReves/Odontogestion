...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <a href="clients/create" class="btn btn-primary mb-4">Crear Nuevo</a>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
                        ...
                        @foreach ($clients as $row)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="clients/{{ $row->id }}/edit" class="btn btn-info">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="{{ route('clients.delete', $row->id) }}" method="POST"
